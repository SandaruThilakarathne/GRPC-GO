...
func main() {
	...
	fmt.Println("Starting Blog Service Server")
	collection = client.Database("grpcp-go").Collection("blog")
...
func (*server) UpdateBlog(ctx context.Context, req *blogpb.UpdateBlogRequest) (*blogpb.UpdateBlogResponse, error)  {
	...
	if updateErr != nil {
		return nil, status.Errorf(
			codes.Internal,
			fmt.Sprintf("Cannot update obejct in MongoDB: %v", err),
		)
	}
